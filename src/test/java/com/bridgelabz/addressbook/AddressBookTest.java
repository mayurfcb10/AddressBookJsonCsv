...
public class AddressBookTest {
    ...
    public void givenContactToBeAdded_shouldreturntheContactAddedinDBandinSyncWithDB() throws AddressBookException {
        addressBookService.addContactDetails("Rahul","Dixit","Housing","Mhow","Maharastra","rahul.eee18@bhu.in","6868686887","400007",4,
                103, "professional.",LocalDate.of(2019,8,28));
